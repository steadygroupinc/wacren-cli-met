export default function Alignment() {
  const alignments = [
    ...
    { title: "WMO Global Climate Observing System", desc: "WMO-compliant weather stations and data standards connect the region to the global climate observation infrastructure.", icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9z" /></svg> },
  ];
